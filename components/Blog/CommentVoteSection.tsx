  ...
  const UpVoteIcon = (props: VoteSectionProps) => {
    ...
    return (
      <div
        ...
        onClick={() => VoteOnComment(props.postId, props.comment.id, props.user, true, !!userHasUpvoted, false)}
      >
  ...
  const DownVoteIcon = (props: VoteSectionProps) => {
    ...
    return (
      <div
        ...
        onClick={() => VoteOnComment(props.postId, props.comment.id, props.user, false, false, !!userHasDownvoted)}
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="24" height="24" fill="currentColor">
          <path
