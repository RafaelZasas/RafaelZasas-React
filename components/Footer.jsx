...
const navigation = {
    ...
    contact: [
        { name: <div><FontAwesomeIcon icon={faEnvelope} color={'currentColor'}/> Mail</div> , href: 'mailto:admin@rafaelzasas.com' },
        { name: <div><FontAwesomeIcon icon={faPhoneSquare} color={'currentColor'}/> Tel</div>, href: 'tel:+13106002053' },
        { name: <div><FontAwesomeIcon icon={faBug} color={'currentColor'}/> Bug Report</div>, href: '/feedback' },
    ],
    social: [
        {
            name: 'LinkedIn',
        ...
        <footer className="bg-blue-50 fixed inset-x-0 bottom-0" aria-labelledby="footer-heading">
            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div className="space-y-8 xl:col-span-1">
                        <p className="text-gray-500 text-base">
                            A digital portfolio of an aspiring Software Developer.
                            This Front-end is built using React and NextJs. Backend operations are done mostly through Firebase & GCP.
                        </p>
                    ...
                    <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">Tools used</h3>
                            ...
                            <div className="mt-12 md:mt-0">
                                <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">Credit</h3>
                                <ul role="list" className="mt-4 space-y-4">
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="text-base text-gray-400 xl:text-center">&copy; 2021 RZ Developments, Inc. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
